...
const navigation = [
  ...
  { name: "Seller Search", href: "/sellers", icon: Store },
  { name: "My Transactions", href: "/transactions", icon: Receipt },
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-border">
            <h1 className="text-xl font-semibold bg-gradient-to-r from-professional-blue to-professional-teal bg-clip-text text-transparent">
              Buyer Portal
            </h1>
            <Button
              variant="ghost"
      ...
      <div className="lg:pl-64">
        ...
        <div className="sticky top-0 z-30 flex h-14 items-center gap-4 bg-card/80 backdrop-blur-sm border-b border-border px-4 lg:hidden">
          ...
          <h1 className="text-lg font-semibold">Buyer Portal</h1>
        </div>
